...
Config.FuelResource = "ox_fuel" -- "nothing" - no fuel resource, "native" - will use the FiveM natives, "okokGasStation", "legacyfuel", "ox_fuel"
...
Config.DefaultImpoundTime = 3600 -- Default impound time in seconds (1 hours)
