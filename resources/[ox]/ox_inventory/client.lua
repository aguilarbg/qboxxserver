...
exports('useJointRelief', function()
    lib.notify({ title = 'Joint Relief', description = 'Your joints feel better.', type = 'success' })
    SetRunSprintMultiplierForPlayer(PlayerId(), 1.05)
    Wait(300000)
    TriggerServerEvent('qbx-aging:applyAgeEffects')
end)

exports('useBackCream', function()
    lib.notify({ title = 'Back Cream', description = 'Your back pain is relieved.', type = 'info' })
    ResetPedMovementClipset(PlayerPedId(), 1.0)
    Wait(600000)
    TriggerServerEvent('qbx-aging:applyAgeEffects')
end)

exports('useVitamins', function()
    lib.notify({ title = 'Vitamins', description = 'You feel more energetic.', type = 'success' })
    RestorePlayerStamina(PlayerId(), 1.0)
end)

exports('usePainInjection', function()
    lib.notify({ title = 'Pain Injection', description = 'You feel no pain.', type = 'success' })
    ResetPedMovementClipset(PlayerPedId(), 1.0)
