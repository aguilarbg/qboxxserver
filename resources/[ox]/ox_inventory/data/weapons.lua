return {
	Weapons = {
		...
		-- Project X Custom Weapons
		['WEAPON_PROJECTX'] = {
			label = 'Project X Custom Carbine Rifle MK2',
			weight = 1600,
			durability = 0.03,
			ammoname = 'ammo-rifle',
		},
	...
	Components = {
		...
		-- Project X Custom Weapons Components
		['prjectx_clip'] = {
			label = 'Project X Clip',
			weight = 200,
			type = 'clip',
			client = {
				component = {'COMPONENT_PROJECTX_CLIP_01'},
				usetime = 2500
			}
		},
			['prjectx_suppressor'] = {
			label = 'Project X Suppressor',
			weight = 200,
			type = 'suppressor',
			client = {
				component = {'COMPONENT_AT_PROJECTX_SUPP'},
				usetime = 2500
			}
		},
		['arctic516_clip'] = {
			label = 'Arctic 516 Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_ar_arctic516_mag1'},
				usetime = 2500
			}
		},
		['arctic516_extended_clip'] = {
			label = 'Arctic 516 Extended Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_ar_arctic516_mag2'},
				usetime = 2500
			}
		},
		['arctic516_suppressor'] = {
			label = 'Arctic 516 Suppressor',
			weight = 200,
			type = 'suppressor',
			client = {
			component = {'w_at_arctic516_supp'},
			usetime = 2500
			}   
		},
		['arctic516_scope'] = {
			label = 'Arctic 516 Scope',
			weight = 200,
			type = 'sight',
			client = {
			component = {'w_at_arctic516_scope'},
			usetime = 2500
			}   
		},
		['arctic516_grip'] = {
			label = 'Arctic 516 Grip',
			weight = 200,
			type = 'grip',
			client = {
			component = {'w_at_arctic516_afgrip'},
			usetime = 2500
			}   
		},
		['projectxpistol_clip'] = {
			label = 'Project X Glock 19X Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_pi_projectxpistol_mag1'},
				usetime = 2500
			}
		},
		['projectxpistol_extended_clip'] = {
			label = 'Project X Glock 19X Extended Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_pi_projectxpistol_mag2'},
				usetime = 2500
			}
		},
		['projectxpistol_suppressor'] = {
			label = 'Project X Glock 19X Suppressor',
			weight = 200,
			type = 'suppressor',
			client = {
			component = {'w_at_projectxpistol_supp'},
			usetime = 2500
		}
		},
		['projectxsmg_clip'] = {
			label = 'Project X P90 Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_sb_projectxsmg_mag1'},
				usetime = 2500
			}
		},
		['projectxsmg_extended_clip'] = {
			label = 'Project X Pistol P90 Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_sb_projectxsmg_mag2'},
				usetime = 2500
			}
		},
		['projectxsmg_suppressor'] = {
			label = 'Project X P90 Suppressor',
			weight = 200,
			type = 'suppressor',
			client = {
			component = {'w_at_projectxsmg_supp'},
			usetime = 2500
		}
		},
		['origin12_clip'] = {
			label = 'Origin-12 Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_sb_origin12_mag1'},
				usetime = 2500
			}
		},
		['origin12_extended_clip'] = {
			label = 'Origin-12 Extended Clip',
			type = 'magazine',
			weight = 200,
			client = {
				component = {'w_ar_origin12_mag2'},
				usetime = 2500
			}
		},
		['origin12_suppressor'] = {
			label = 'Origin-12 Suppressor',
			weight = 200,
			type = 'suppressor',
			client = {
			component = {'w_at_origin12_supp'},
			usetime = 2500
			}   
		},
		['origin12_scope'] = {
			label = 'Origin-12 Scope',
			weight = 200,
			type = 'sight',
			client = {
			component = {'w_at_origin12_scope'},
			usetime = 2500
			}   
		},
